...
UI_STRINGS: Dict[str, Dict[str, str]] = {
    "pt": {
        ...
        "install_audio": "Instale com: pip install -r requirements.txt",
        "quiz_unavailable": "Ainda não há traduções suficientes para este idioma no dicionário.",
    ...
    "es": {
        ...
        "install_audio": "Instala con: pip install -r requirements.txt",
        "quiz_unavailable": "Todavía no hay suficientes traducciones para este idioma en el diccionario.",
        "level_progress": "Progreso hacia el próximo nivel",
        "context": "Contexto",
    },
    "en": {
        "app_title": "BibleLingo",
        ...
        "install_audio": "Install with: pip install -r requirements.txt",
        "quiz_unavailable": "There are not enough translations for this language yet.",
    ...
    "ar": {
        ...
        "install_audio": "ثبّت باستخدام: pip install -r requirements.txt",
        "quiz_unavailable": "لا توجد ترجمات كافية لهذه اللغة في القاموس بعد.",
        "level_progress": "التقدم إلى المستوى التالي",
        "context": "السياق",
    },
    "he": {
        "app_title": "BibleLingo",
        ...
        "install_audio": "התקן עם: pip install -r requirements.txt",
        "quiz_unavailable": "עדיין אין מספיק תרגומים לשפה זו במילון.",
